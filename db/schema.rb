...
ActiveRecord::Schema.define(version: 2022_06_07_063509) do

  create_table "test_comments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "test_id", null: false
    t.text "content", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["test_id"], name: "index_test_comments_on_test_id"
  ...
  add_foreign_key "test_comments", "tests"
