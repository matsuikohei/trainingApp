...
上部に「Training App」と表示される。下部に研修内容一覧ページと試験結果一覧ページへのリンクが表示される。「見る」ボタンを押すと研修内容または試験結果の一覧ページへ遷移する。

[![Image from Gyazo](https://i.gyazo.com/c8147a4c872e53218921ec416d2e4514.png)](https://gyazo.com/c8147a4c872e53218921ec416d2e4514)
